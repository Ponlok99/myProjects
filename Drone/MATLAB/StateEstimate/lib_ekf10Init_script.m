% LIB_EKF10INIT_SCRIPT   Generate static library ekf10Init from ekf10Init,
%  ekf10Step, initStateEKF.
% 
% Script generated from project 'lib_ekf10Init.prj' on 21-Jul-2025.
% 
...
%% Invoke MATLAB Coder.
codegen -config cfg ekf10Init -args ARGS{1} ekf10Step -args ARGS{2} initStateEKF -args ARGS{3}
